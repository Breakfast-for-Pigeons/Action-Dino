...
def print_header():
    ...
    print("\033[1;32;40m")                        # print green header
    print(r"""
    ==========================================================================
                   _        _   _               ____  _
                  / \   ___| |_(_) ___  _ __   |  _ \(_)_ __   ___
                 / _ \ / __| __| |/ _ \| '_ \  | | | | | '_ \ / _ \
                / ___ \ (__| |_| | (_) | | | | | |_| | | | | | (_) |
               /_/   \_\___|\__|_|\___/|_| |_| |____/|_|_| |_|\___/
...
def activate_t_rex(sound, sound_length):
    ...
    try:
        T_REX_MOTOR.value = 0.4        # Controls the motor speed
    except ValueError:
